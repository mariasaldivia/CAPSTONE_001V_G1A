  ...
  return (
    ...
    <main>
      ...
      <section id="destacada">
        ...
        <h3>Nuestro compromiso se basa en tres pilares fundamentales que nos permiten crecer juntos.</h3>
        <div className="feature-grid">
          <div className="feature-item">
      ...
      <section id="directiva">
        ...
        <h3 className="bajada">Somos la voz organizada de nuestra comunidad. Acércate y conoce a las líderes que trabajan día a día por el bienestar de Mirador de Volcanes IV.</h3>
      ...
      <section id="contacto">
        <div class="contacto-wrapper">
          <h2>Contáctanos y Participa</h2>
          <p>Tu voz es importante. Utiliza cualquiera de estos canales para comunicarte con la Directiva:</p>

          <div class="info-grid">
            <p>📧 <a href="mailto:juntadevecinosvolcanescuatro@gmail.com">juntadevecinosvolcanescuatro@gmail.com </a></p>
            <p>📞 +56 9 6235 0561</p>
            <p> Lily Garafulic Yancovic 1787, Puerto Montt, Los Lagos </p>
            <p><a href="https://maps.app.goo.gl/vf6vygvr9mSxKMVE6" target="_blank">Ver en Google Maps</a></p>
          </div>
          
          <a href="/register" className="cta-button">Hazte socio y recibe las novedades</a>
        </div>
      </section>
    </main>
  );
